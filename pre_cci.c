# 1 "c:\\users\\dkame\\desktop\\finally\\check_emails\\\\combined_check_emails.c"
...
# 1 "c:\\users\\dkame\\desktop\\finally\\check_emails\\\\combined_check_emails.c" 2
...
# 2 "c:\\users\\dkame\\desktop\\finally\\check_emails\\\\combined_check_emails.c" 2
...
# 3 "c:\\users\\dkame\\desktop\\finally\\check_emails\\\\combined_check_emails.c" 2
...
{	
	...
	lr_end_transaction("UC01_loading",2);
...
# 4 "c:\\users\\dkame\\desktop\\finally\\check_emails\\\\combined_check_emails.c" 2
...
{	
	...
	lr_end_transaction("UC03_open_folder",2);
	...
	web_url("hash_2",
		...
		"Mode=HTML",
		"LAST");
lr_end_transaction("UC04_read_msgs", 2);
lr_start_transaction("UC05_move_msg");
	...
	web_submit_data("move",
		...
		"Name=token", "Value={token}", "ENDITEM",
		"LAST");
	lr_end_transaction("UC05_move_msg", 2);
...
# 5 "c:\\users\\dkame\\desktop\\finally\\check_emails\\\\combined_check_emails.c" 2
...
vuser_end()
{
	...
	lr_end_transaction("UC06_logout",2);
	lr_end_transaction("UC_check_email", 2);

	return 0;
}
# 6 "c:\\users\\dkame\\desktop\\finally\\check_emails\\\\combined_check_emails.c" 2
